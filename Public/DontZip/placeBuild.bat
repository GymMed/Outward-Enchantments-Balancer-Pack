...
:: Source paths
set "sourceDll=C:\Users\pc\source\repos\OutwardEnchantmentsBalancerPack\Release\OutwardEnchantmentsBalancerPack.dll"
...
if exist "%sourceDll%" (
    for %%p in (%profiles%) do (
        set "destinationDll=%baseProfilePath%\%%~p\BepInEx\plugins\gymmed-OutwardEnchantmentsBalancerPack"
